...
export default function Payment() {
  ...
  const back = Number(setup.amountUsers || 1) === 1 ? "/create-account" : "/company-details";
  return <FlowLayout step={3} title="Activate Your Account" subtitle="Complete the one-time activation payment to begin receiving RFQ alerts.">
    <div className="fee-card"><span>One-Time Activation Fee</span><strong>$50.00</strong></div>
    ...
    <div className="form-divider" /><div className="form-actions"><button className="back-button" onClick={() => navigate(back)}><ArrowLeft size={18} /> Back</button><button className="continue-button" type="button">Pay $50.00 and Activate <ArrowRight size={18} /></button></div>
  </FlowLayout>;
}