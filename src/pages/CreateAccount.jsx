...
export default function CreateAccount() {
  ...
  const submit = (e) => { e.preventDefault(); if (emailError) return; const data = { ...saved, ...form, amountUsers: Number(form.amountUsers) }; localStorage.setItem("rfqWatchSetup", JSON.stringify(data)); navigate(data.amountUsers === 1 ? "/new-customer-payment" : "/recipients-new"); };
