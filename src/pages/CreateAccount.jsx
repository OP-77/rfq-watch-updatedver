  ...
  return <FlowLayout step={1} title="Create Your Account" subtitle="Enter your contact details and tell us how many recipients need access.">
    <form className="rfq-form" onSubmit={submit}>
      <div className="form-grid">
        ...
        <label>Email Address <span>*</span><input name="email" type="email" value={form.email} onChange={update} placeholder="you@company.com" required className={emailError ? "input-error" : ""} />{emailError ? <small className="text-red-500">{emailError}</small> : <small>RFQ alerts will be sent to this address.</small>}</label>
