  ...
  return <div className="landing-page">
    ...
    <main className="landing-hero">
      ...
      <section className="setup-card">
        ...
        <div className="gold-rule" />
        <p className="text-slate-500 mb-2 not-italic normal-case">RFQ Watch Lite keeps you in the loop.
RFQ Watch Pro puts your whole team ahead of the curve.

With a Dynamic Dashboard, Detailed nalytics on your competition, and advanced look-up functions, RFQ Watch Pro gives you everything you need to win more government contracts.</p>
